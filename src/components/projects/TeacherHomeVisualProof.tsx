  ...
  return (
    <div dir="rtl" className="min-h-screen bg-[#f5f3ee] text-[#183047] font-sans overflow-auto">
      <div className="min-h-screen grid grid-cols-[224px_minmax(0,1fr)]">
        <aside className="relative bg-[#153f35] text-white px-4 py-5 overflow-hidden">
          ...
          <div className="absolute inset-x-0 bottom-0 h-[330px] pointer-events-none">
            <img
              className="absolute inset-0 w-full h-full object-cover opacity-45 mix-blend-luminosity"
              src="https://images.unsplash.com/photo-1526772662000-3f88f10405ff?auto=format&fit=crop&w=700&q=80"
              alt=""
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#173d35] via-[#173d35]/55 to-transparent" />
        ...
        <main className="min-w-0">
          ...
          <div className="p-5 xl:p-6 space-y-4 max-w-[1520px] mx-auto">
            <section className="relative h-[230px] rounded-[20px] overflow-hidden shadow-[0_14px_34px_-24px_rgba(20,51,43,.55)] border border-black/5">
              <img
                src="https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=1800&q=88"
                className="absolute inset-0 w-full h-full object-cover"
                alt=""
              />
              <div className="absolute inset-0 bg-gradient-to-l from-[#102b25]/90 via-[#173f34]/46 to-black/5" />
              <div className="absolute inset-y-0 right-0 w-[64%] p-10 text-white flex flex-col justify-center">
              ...
              <div className="absolute left-9 top-8 rotate-[-4deg] bg-[#f5ead7]/97 text-[#2c3f48] px-6 py-5 shadow-[0_14px_30px_-16px_rgba(0,0,0,.5)] font-serif italic text-[21px] leading-8 border border-white/70">
                מקומות אמיתיים.<br />אנשים אמיתיים.<br />למידה עמוקה יותר.
              </div>
            </section>

            <section className="grid grid-cols-3 gap-3.5">
              <div className="rounded-[16px] bg-[#e8f5ef] px-5.5 h-[104px] flex items-center gap-4.5">
                <div className="w-14 h-14 rounded-full bg-[#d6eee4] grid place-items-center text-[#126b52]"><Users size={33} /></div>
                <div><div className="text-[29px] font-black leading-none">4</div><div className="font-semibold mt-1">קבוצות פעילות</div><button className="text-[#167157] text-[13px] font-bold mt-2">צפייה בקבוצות ←</button></div>
              </div>
            ...
            <section className="grid grid-cols-[1.3fr_.85fr] gap-4 pb-5">
              ...
              <div className="relative overflow-hidden rounded-[18px] border border-[#eadfcb] bg-[#f7f0e3] min-h-[235px] p-6 shadow-[0_10px_24px_-20px_rgba(35,50,43,.28)]">
